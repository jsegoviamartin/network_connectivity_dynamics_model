            ...
            if name <= 8:
                if r < 3:
                    if not (shown == observed == 0):
                        result = ((0.98) * (1.0 - 0.9) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0.9) * (self.coord) * observed / r) + ((0.98) * 0.9 * s) + ((self.mut / 4))
                    else:
                        result = ((0.98) * (1.0 - 0) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0) * (self.coord) * observed / r) + ((0.98) * 0 * s) + ((self.mut / 4))
                else:
                    if not (shown == observed == 0):
                        result = ((0.98) * (1.0 - 0.6) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0.6) * (self.coord) * observed / r) + ((0.98) * 0.6 * s2) + ((self.mut / 4))
                    else:
                        result = ((0.98) * (1.0 - 0) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0) * (self.coord) * observed / r) + ((0.98) * 0 * s2) + ((self.mut / 4))

            else:
                if r < 2:
                    if not (shown == observed == 0):
                        result = ((0.98) * (1.0 - 1) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 1) * (self.coord) * observed / r) + ((0.98) * 1 * s) + ((self.mut / 4))
                    else:
                        result = ((0.98) * (1.0 - 0) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0) * (self.coord) * observed / r) + ((0.98) * 0 * s) + ((self.mut / 4))
                else:
                    if not (shown == observed == 0):
                        result = ((0.98) * (1.0 - 0.5) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0.5) * (self.coord) * observed / r) + ((0.98) * 0.5 * s) + ((self.mut / 4))
                    else:
                        result = ((0.98) * (1.0 - 0) * (1.0 - self.coord) * shown / r) + ((0.98) * (1.0 - 0) * (self.coord) * observed / r) + ((0.98) * 0 * s) + ((self.mut / 4))
...
def main():
    ...
    samples = [{'cont': 0.7, 'coord': 0.5, 'mut': 0.02} for _ in range(1)]
    ...
    with open('Sim_Late_cal.csv', 'wb') as csvfile:
